...
struct StoryBrain {
    ...
    var storyNumber = 0
    mutating func nextChoice(userChoice: String) {
        let answer = userChoice
        if answer == stories[storyNumber].choice1 {
            storyNumber = stories[storyNumber].choice1Destination
        } else {
            storyNumber = stories[storyNumber].choice2Destination
        }
    }
    func setStoryLabel() -> String {
        return stories[storyNumber].title
    }
    func setChoice1Button() -> String {
        return stories[storyNumber].choice1
    }
    func setChoice2Button() -> String {
